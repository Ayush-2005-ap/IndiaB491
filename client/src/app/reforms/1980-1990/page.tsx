  ...
  return (
    <>
      <div className="flex flex-col w-full">
        {/*  Header Section  */}
        <section className="w-full px-6 md:px-16 lg:px-24 pt-24 pb-16">
        ...
        {/*  Content Section  */}
        <section className="w-full px-6 md:px-16 lg:px-24 relative">
            ...
            <article className="space-y-12">
              <div className="space-y-6">
                <p className="font-body-lg text-body-lg text-on-surface leading-relaxed">
                  ...
                  he GDP growth rate improved (from an average of 2.9 percent in 1970s to 5.6 percent in 1980s) during the 1980s. This was primarily due to two reasons: Liberalisation of industry and trade (reforms of 1980s), and borrowing from abroad alongside rising government expenditure at home.
                </p>
                <p className="font-body-lg text-body-lg text-on-surface leading-relaxed">
